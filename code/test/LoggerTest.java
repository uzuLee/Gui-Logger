 ...
 * Logger 프로세스의 테스트 대리 스크립트입니다 (Java 버전).
 *
...
public class LoggerTest {
     ...
     * @param pauseFlagPath The path to the pause flag file.
    ...
    /**
     * Defines the structure for a simulated log message.
     * 시뮬레이션된 로그 메시지의 구조를 정의합니다.
     */
