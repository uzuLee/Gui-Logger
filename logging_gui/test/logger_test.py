"""
# Logger 프로세스의 테스트 대리(Surrogate) 스크립트입니다.
# Test Surrogate for Logger Process.
...
log('SYSTEM', '--- Starting Logger Test Surrogate ---')
...
log('SYSTEM', '--- Logger Test Surrogate Finished ---')